...
class OnboardingTests: XCTestCase {
    ...
    func testOnboardWithThingID_already_onboarded_error() {
        ...
        api._target = Target(targetType: TypedID(type: "thing", typedID: "th.0267251d9d60-1858-5e11-3dc3-00f3f0b5"))
    ...
    func testOnboardWithVendorThingIDAndImplementTag() {
        ...
        api = IoTCloudAPIBuilder(appID: "50a62843", appKey: "2bde7d4e3eed1ad62c306dd2144bb2b0",
            site: Site.CUSTOM("https://api-development-jp.internal.kii.com"), owner: Owner(ownerID: TypedID(type:"user", typedID:"53ae324be5a0-2b09-5e11-6cc3-0862359e"), accessToken: "BbBFQMkOlEI9G1RZrb2Elmsu5ux1h-TIm5CGgh9UBMc"),tag:"target1").build()
        do{
            let thingProperties:Dictionary<String, AnyObject> = ["key1":"value1", "key2":"value2"]
            let thingType = "LED"
            let vendorThingID = "th.abcd-efgh"
