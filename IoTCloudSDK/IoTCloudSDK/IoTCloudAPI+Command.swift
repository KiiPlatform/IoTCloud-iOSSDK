...
extension IoTCloudAPI {
        ...
        ) -> Void
    {
        ...
        let requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/commands"
        ...
        )
    {
        ...
        let requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/commands/\(commandID)"
        ...
        )
    {
        ...
        var requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/commands"
