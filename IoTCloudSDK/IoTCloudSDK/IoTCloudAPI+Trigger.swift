...
extension IoTCloudAPI {
        ...
        )
    {
        ...
        let requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/triggers"

        // generate header
        let requestHeaderDict:Dictionary<String, String> = ["authorization": "Bearer \(owner.accessToken)", "content-type": "application/json"]

        // generate command
        let commandDict = NSMutableDictionary(dictionary: ["schema": schemaName, "schemaVersion": schemaVersion, "issuer":owner.ownerID.toString(), "target":self.target!.targetType.toString()])
        ...
        )
    {
        ...
        let requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/triggers/\(triggerID)"
        ...
        )
    {
        ...
        let requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/triggers/\(triggerID)/\(enableString)"
        ...
        )
    {
        ...
        var requestURL = "\(baseURL)/iot-api/apps/\(appID)/targets/\(self.target!.targetType.toString())/triggers"
