//
//  NotifyOnboardingCompletionTests.swift
//  ThingIFSDK
//
...
class NotifyOnboardingCompletionTests: GatewayAPITestBase {
    ...
    func testSuccess()
    {
        ...
        let requestVerifier: ((NSURLRequest) -> Void) = {(request) in
            ...
            //verify body
            let expectedBody: Dictionary<String, AnyObject> = [ "thingID": thingID];
